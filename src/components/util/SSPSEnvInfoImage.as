package components.util
{
    ...
    public class SSPSEnvInfoImage extends Image
    {
    	
    	[Embed(source="components/control/noMapAvailable.jpg")]
	    private var notAvailable:Class; 	
    	
        private var targetImage:Image;

        public function SSPSEnvInfoImage(){
        	super();
