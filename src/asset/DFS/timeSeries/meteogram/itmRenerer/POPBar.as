package asset.DFS.timeSeries.meteogram.itmRenerer
{
	...
	public class POPBar extends UIComponent implements IDataRenderer
	{
		private var label:Label;
		private var _chartItem:ChartItem; // stores current ColumnSeriesItem

	    public function POPBar():void
	    {
	        super();	        
	    }
...
//			g.beginGradientFill(GradientType.LINEAR,[0x0055EE,0x0055EE],[0.6,0.6],[0,255],null,null,null,0);
