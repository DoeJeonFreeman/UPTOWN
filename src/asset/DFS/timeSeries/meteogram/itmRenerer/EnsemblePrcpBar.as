package asset.DFS.timeSeries.meteogram.itmRenerer
{
	...
	public class EnsemblePrcpBar extends UIComponent implements IDataRenderer
	{
		private var label:Label;
		private var _chartItem:ChartItem; // stores current ColumnSeriesItem

	    public function EnsemblePrcpBar():void
	    {
	        super();	        
	    }
...
//                             alpha="1.0" />
	...
	//			g.lineStyle(1,0xCCCCCC,0.2);								//alpha     ratio [0x0088EE,0xFCFCFD] 0x0077EE,0xFCFCFD
				...
				g.beginGradientFill(GradientType.LINEAR,[0xb8e7f2,0xb8e7f2],[1,1],[0,255],null,null,null,0);
