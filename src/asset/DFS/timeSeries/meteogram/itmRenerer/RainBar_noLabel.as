package asset.DFS.timeSeries.meteogram.itmRenerer
{
	...
	public class RainBar_noLabel extends UIComponent implements IDataRenderer
	{
		private var label:Label;
		private var _chartItem:ChartItem; // stores current ColumnSeriesItem

	    public function RainBar_noLabel():void
	    {
	        super();	        
	    }
...
//			g.beginFill(0xff0000, 0.9);
			...
			g.beginGradientFill(GradientType.LINEAR,[0x0077EE,0x0077EE],[0.5,0.3],[0,255],null,null,null,0);
