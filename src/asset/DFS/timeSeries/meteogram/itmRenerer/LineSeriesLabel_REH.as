package asset.DFS.timeSeries.meteogram.itmRenerer{
	...
	public class LineSeriesLabel_REH extends UIComponent implements IDataRenderer{
...
//		public var labelPrecision:uint;
		...
		public function LineSeriesLabel_REH():void{
			super();
			_label = new Label();
			 addChild(_label);
