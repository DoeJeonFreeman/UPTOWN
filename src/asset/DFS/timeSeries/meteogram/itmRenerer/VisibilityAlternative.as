package asset.DFS.timeSeries.meteogram.itmRenerer
{
	...
	public class VisibilityAlternative extends UIComponent implements IDataRenderer
	{
		private var label:Label;
		private var _chartItem:ChartItem; // stores current ColumnSeriesItem

	    public function VisibilityAlternative():void
	    {
	        super();	        
	    }
...
//				g.lineStyle(1,0x0077EE,.3);								//alpha     ratio [0x0088EE,0xFCFCFD] 0x0077EE,0xFCFCFD
//				g.beginGradientFill(GradientType.LINEAR,[0x4db6dd,0x4db6dd],[1,1],[0,100],null,null,null,0);
				g.beginGradientFill(GradientType.LINEAR,[0x0077EE,0xd1e3f0],[0.1,0.9],[0,255],null,null,null,0);
				//scattered 0xd1e3f0
				//broken	0x72b2d8
				//overcast  0x3e89c2
//				g.beginFill(0xd1e3f0,1.0) 
