package asset.DFS.timeSeries.meteogram.itmRenerer
{
	...
	public class R12BarRenderer_GDPS extends UIComponent implements IDataRenderer
	{
...
//		public var showSeriesLabel:Boolean = false;
	    ...
	    public function R12BarRenderer_GDPS():void
	    {
	        super();	        
	    }
...
//	       	}
			...
			g.lineStyle(1,0x33BBDD,0.4);								//alpha     ratio [0x0088EE,0xFCFCFD] 0x0077EE,0xFCFCFD
			g.beginFill(0x33BBDD,.3);
